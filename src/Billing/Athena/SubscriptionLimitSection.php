...
class SubscriptionLimitSection extends AbstractSection
{
    public function __construct(private SubscriptionLimitRepositoryInterface $limitRepository)
    {
    }

    public function getUrlTag(): string
    {
        return 'billing-subscription-limits';
    }
    ...
    {
        $listView->addField('name', 'text')->addField('code', 'text')->addField('description', 'text');
